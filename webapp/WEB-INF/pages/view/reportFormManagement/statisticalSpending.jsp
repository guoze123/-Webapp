...
<head>
  ...
  <link rel="stylesheet"
    href="${pageContext.request.contextPath}/pages/css/reportFormManagement/statisticalSpending.css" />
  <script>
...
<body class="gray-bg">
  ...
  <script src="${pageContext.request.contextPath}/pages/js/reportFormManagement/statisticalSpending.js"></script>
</body>

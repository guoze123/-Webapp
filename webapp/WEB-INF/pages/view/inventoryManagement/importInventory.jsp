...
<head>
    ...
    <link rel="stylesheet"
        href="${pageContext.request.contextPath}/pages/css/inventoryManagement/importInventory.css" />
...
<body class="gray-bg">
            ...
            <div class="textContent">
                <div class="list_row">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control ordernum" placeholder="订单号" />
                    </div>
                </div>
                <div class="list_row">
    ...
    <script
        src="${pageContext.request.contextPath}/pages/js/plugins/bootstrap-table/bootstrap-table-export.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/pages/js/inventoryManagement/importInventory.js"></script>
</body>

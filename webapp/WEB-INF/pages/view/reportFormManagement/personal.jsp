...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/pages/css/reportFormManagement/personal.css" />
  <script>
...
<body class="gray-bg">
      ...
      <div class="col-sm-4" style="padding-left: 7px;padding-right: 7px;">
        <div class="ibox float-e-margins">
          ...
          <div class="ibox-content">
            <div id="sales_bar" style="width: 100%; height: 200px;"></div>
          </div>
        </div>
        <div class="ibox float-e-margins">
          <div class="ibox-title">
          ...
          <div class="ibox-content">
            <div id="serving_bar" style="width: 100%; height: 200px;"></div>
          </div>
        </div>
      </div>
                ...
                <div class="example">
                  <div class="searchList ">
                    ...
                    <div class="right">
                      ...
                      <input type="text" class="form-control query_userinformation" placeholder="个人信息" />
                      <span>
                  ...
                  <table id="personal" data-mobile-responsive="true"></table>
                </div>
              </div>
            </div>
          </div>
  ...
  <script src="${pageContext.request.contextPath}/pages/js/reportFormManagement/personal.js"></script>
</body>

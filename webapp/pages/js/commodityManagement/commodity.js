(function(document, window, $) {
      ...
      firm("提示", "是否删除", function() {
        ...
        ajax_data(
          ...
          function(res) {
            ...
            if (res.resultCode > -1) {
              tips("删除成功", 6);
              $("#waresManagement").bootstrapTable("selectPage",1);
  ...
  function queryParams() {
    return {
      waresName: $(".searchList .query_wares_name")
        .val()
        .trim()
        ? $(".searchList .query_wares_name")
            .val()
            .trim()
        : undefined,
      categoryName: $(".searchList .query_category_name")
        .val()
        .trim()
        ? $(".searchList .query_category_name")
            .val()
            .trim()
        : undefined
    };
  ...
  function confirmFn() {
    ...
    let params = {
      waresId: $(".wares_name").attr("data-waresId")
        ...
        : -1,
      waresName: $(".wares_name")
        .val()
        .trim(), // 名称
      categoryName: $(".category_name")
        .val()
        .trim(), //商品分类名称
      waresPrice: $(".wares_price")
        .val()
        .trim(), //商品价格
      waresDesc: $(".wares_desc")
        .val()
        .trim() //商品描述
    };
    let url;
